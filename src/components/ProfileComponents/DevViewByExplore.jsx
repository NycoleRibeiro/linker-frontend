...
export function DevViewByExplore(props) {

    // TELA DIFERENTE DO 'DevView'
    // Nesta tela o dev que aparece não necessariamente se candidatou a alguma vaga da empresa
    // Por esse motivo, não há a guia "teste" e nem o texto com a vaga candidatada abaixo do nome do dev
...
export default DevViewByExplore;
